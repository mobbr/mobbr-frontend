!function () {
    ...
    a.prototype = new Error, a.prototype.name = "InvalidCharacterError", b.btoa || (b.btoa = function (b) {
        for (var d, e, f = 0, g = c, h = ""; b.charAt(0 | f) || (g = "=", f % 1); h += g.charAt(63 & d >> 8 - f % 1 * 8)) {
            if (e = b.charCodeAt(f += .75), e > 255)throw new a("'btoa' failed: The string to be encoded contains characters outside of the Latin1 range.");
            d = d << 8 | e
        }
        return h
    }), b.atob || (b.atob = function (b) {
        if (b = b.replace(/=+$/, ""), b.length % 4 == 1)throw new a("'atob' failed: The string to be decoded is not correctly encoded.");
        for (var d, e, f = 0, g = 0, h = ""; e = b.charAt(g++); ~e && (d = f % 4 ? 64 * d + e : e, f++ % 4) ? h += String.fromCharCode(255 & d >> (-2 * f & 6)) : 0)e = c.indexOf(e);
        return h
    })
}(), function (a) {
    "use strict";
...
var mobbr = mobbr || function () {
        ...
        function d() {
            if (!p) {
                ...
                a.setAttribute("id", "mobbr_div"), a.setAttribute("name", "mobbr_div"), a.style.cssText = "opacity:0.95;filter:alpha(opacity=95); display:none; position: fixed; border: 4px solid #999; background: none repeat scroll 0% 0% #fff; top: 8px; right: 8px; padding:15px 0px 0px 0px; width: 492px; height: 338px; z-index: 2147483647; border-radius: 10px; -moz-border-radius: 15px; -webkit-border-radius: 15px; -khtml-border-radius: 15px;";
                var b = document.createElement("a");
                b.style.cssText = "float:right; position:relative; top:-17px; right:5px; text-decoration:none; font-size:7pt; color:black;font-family: Arial, Helvetica, sans-serif;", b.onclick = k, b.innetText = "[close window] ";
                var c = document.createElement("img");
                c.style.cssText = "position:relative;top:5px;width: 24px;height: 24px", c.src = n + "/img/frame_closebutton.png", c.alt = "Close button", q = document.createElement("iframe"), q.setAttribute("name", "mobbr_frame"), q.setAttribute("frameborder", "0"), q.style.cssText = "position:relative;top:-10px;left:0;right:0;bottom:0;opacity:1;filter:alpha(opacity=100); width: 100%; height: 292px; padding:0; margin:0;", q.src = o, b.appendChild(c), a.appendChild(b), a.appendChild(q), p = a, document.body.appendChild(p)
            }
        }
        ...
        function f(a, c, d) {
            var f = "";
            return b(a) ? f = md5(a.replace(/\/$/, "")) : b(a.url) && (f = md5(a.url.replace(/\/$/, ""))), e(m + "/button/" + f + "/" + c, function (b) {
