...
angular.module('mobbr.controllers').controller('TasksFilterController', function ($scope, $rootScope, $state, $stateParams, MobbrUri, MobbrKeywords, MobbrApi) {
    ...
    $rootScope.$on('$stateChangeStart', function (event, toState, toParams) {
        ...
        if ($state.includes('tasks.filter')) {
            queryFilter();
        }
    });
