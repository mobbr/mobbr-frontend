(function () {
    ...
    if (!mobbr_div) {
        ...
        html += '<a href="#" onclick="this.parentNode.style.display=\'none\'"; return false;" style="float:right; position:relative; top:-17px; right:5px; text-decoration:none; font-size:7pt; color:black;font-family: Arial, Helvetica, sans-serif;">close window <img style="position:relative;top:5px;" src="https://mobbr.com/img/frame_closebutton.png"/></a><iframe id="mobbr_frame_bookmarklet" name="mobbr_frame_bookmarklet" style="position:relative; top:-10px; opacity:1;filter:alpha(opacity=100); width: 100%; height: 315px; padding:0; margin:0;" frameborder="0"></iframe>';
