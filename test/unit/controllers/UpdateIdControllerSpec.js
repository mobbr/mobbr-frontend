describe('mobbr.controllers: UpdateIdController', function () {
    ...
    it('should update the users id and redirect to the id settings', function () {

        var hash = '962a76080d7a69f325553e30206d9b52';

        createController(hash);
        httpBackend.expectPUT('https://test-api.mobbr.com/api_v1/user/confirm_email_id', { confirm_token: hash }).respond(200, updateIdResult);
        httpBackend.expectGET('https://test-api.mobbr.com/api_v1/user/ping').respond(200, {});
        httpBackend.flush();
        expect(state.go).toHaveBeenCalledWith('settings.ids');
    });
    ...
    it('should redirect to the homepage with a faulty update key', function () {
        ...
        createController(hash);
        httpBackend.expectPUT('https://test-api.mobbr.com/api_v1/user/confirm_email_id', { confirm_token: hash }).respond(400, updateIdResult);
        httpBackend.flush();
