describe('mobbr.controllers: UpdateIdController', function () {
    ...
    it('should update the users id and redirect to the id settings', function () {
        ...
        httpBackend.expectPUT(url + '/api_v1/user/confirm_email_id', { confirm_token: hash }).respond(200, updateIdResult);
        httpBackend.expectGET(url + '/api_v1/user/ping').respond(200, {});
        httpBackend.flush();
    ...
    it('should redirect to the homepage with a faulty update key', function () {
        ...
        createController(hash);
        httpBackend.expectPUT(url + '/api_v1/user/confirm_email_id', { confirm_token: hash }).respond(400, updateIdResult);
        httpBackend.flush();
