describe('mobbr.controllers: WalletController', function () {
    ...
    it('should fetch another 10 records', function () {
        ...
        scope.more();
        httpBackend.expectGET(url + '/api_v1/xpayments?limit=10&offset=10').respond(200, xPaymentsMoreResult);
        httpBackend.flush();
    ...
    it('should search for records', function () {
        ...
        scope.search();
        httpBackend.expectGET(url + '/api_v1/xpayments?limit=10&offset=0&search=test').respond(200, emptyResult);
        httpBackend.flush();
