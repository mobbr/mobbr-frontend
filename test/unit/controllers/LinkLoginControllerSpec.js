describe('mobbr.controllers: LinkLoginController', function () {
    ...
    it('should log the user in with a login key and redirect to updates', function () {
        ...
        httpBackend.expectPUT(url + '/api_v1/user/link_login', { login_token: hash }).respond(200, loginlinkResult);
        httpBackend.expectGET(url + '/api_v1/user/ping').respond(200, {});
        httpBackend.flush();
    ...
    it('should redirect to the homepage with a faulty login key', function () {
        ...
        createController(hash);
        httpBackend.expectPUT(url + '/api_v1/user/link_login', { login_token: hash }).respond(400, loginlinkResult);
        httpBackend.flush();
