...
//    var UPDATE_USER_ENDPOINT = 'https://test-api.mobbr.com/api_v1/user/update_user';
    ...
    var expectRetrieveXPayment = function () {
        httpBackend.expectGET(common.baseUrl + 'xpayments/info?id=123').respond(200, {'result': {'id': '02910f019533b4df50c8a55e436b7ab4', 'prosumer': '1407507773', 'currency_iso': 'EUR', 'amount': '-5.00000000', 'announceddatetime': '2014-08-08 16:24:46', 'paiddatetime': '2014-08-08 16:24:46', 'faileddatetime': null, 'receive_address': '{\'name\':\'Han Dijk\',\'address\':\'Pathmossingel 98\',\'type\':\'IBAN\',\'iban\':\'nl19trio0254730329\',\'bic\':\'TRIONL2U\'}', 'payment_service': 'mangopay', 'ext_trx_id': '3216249', 'note': 'test user: 1407507773', 'service_message': null}, 'message': null});
    };
    it('should retrieved the given x-payment', function () {
        expectRetrieveXPayment();
        state.includes = function () {
            return true;
        };
        createController();
        ...
        expect(scope.payment).not.toBe(undefined);
        expect(scope.payment.amount).toBe('-5.00000000');
    });
