describe('mobbr.controllers: UpdateEmailController', function () {
    ...
    it('should update the users email address and redirect to the account settings', function () {
        ...
        httpBackend.expectPOST('https://test-api.mobbr.com/api_v1/user/confirm_email', { update_token: hash }).respond(200, updateEmailResult);
        httpBackend.expectGET('https://test-api.mobbr.com/api_v1/user/ping').respond(200, {});
        httpBackend.flush();
    ...
    it('should redirect to the homepage with a faulty update key', function () {
        ...
        createController(hash);
        httpBackend.expectPOST('https://test-api.mobbr.com/api_v1/user/confirm_email', { update_token: hash }).respond(400, updateEmailResult);
        httpBackend.flush();
